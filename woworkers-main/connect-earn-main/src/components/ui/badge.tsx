  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        skill: "border-border bg-muted/50 text-muted-foreground hover:bg-accent hover:text-accent-foreground cursor-default",
        featured: "border-transparent gradient-hero text-primary-foreground",
        glass: "glass border-border/30 text-foreground backdrop-blur-sm",
      },
    },
    defaultVariants: {
      variant: "default",
